...
export default function CanvasInviteTokenPage() {
  ...
  useEffect(() => {
    const acceptInviteToken = async () => {
      ...
      try {
        ...
        setCanvasInfo({ id: canvas.id, title: canvas.title || canvas.name || 'Untitled Canvas' });
        setStatus('success');
    ...
    acceptInviteToken();
  }, [params.token, router, user, authLoading]);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <div className="text-center">
            ...
            <Link
              href={`/auth?redirect=/canvas/invite/${params.token}`}
